...
const enabled = env && !env.JFS_TECH_LOGGER_NO_COLOR && (env.JFS_TECH_LOGGER_FORCE_COLOR || (stdout?.isTTY && !env.CI && env.TERM !== "dumb"));
...
export const orange = enabled ? formatter("\x1b[38;2;255;165;0m", "\x1b[39m") : String;
